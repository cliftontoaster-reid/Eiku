...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   eiku_key_is_released.c                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: lfiorell@student.42nice.fr <lfiorell>      +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/09/24 01:00:09 by lfiorell@st       #+#    #+#             */
/*   Updated: 2025/09/24 02:19:18 by lfiorell@st      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
EIKU_API int eiku_key_is_released(t_eiku_keyboard_state *state, t_keycode key) {
  ...
  return state->keys[key - 1] == EIKU_KEY_STATE_RELEASED;
}