...
int vec2i_dot(t_vec2i a, t_vec2i b) { return (a.x * b.x + a.y * b.y); }
...
bool vec2i_equal(t_vec2i a, t_vec2i b) { return (a.x == b.x && a.y == b.y); }

bool vec2i_is_zero(t_vec2i v) { return (v.x == 0 && v.y == 0); }
